...
class App extends Component {
  ...
  componentDidMount = async () => {
    try {
      ...
      this.listenToTokenTransfer(); // event listener
  ...
  updateUserTokens = async () => {
    let userTokens = await this.tokenInstance.methods.balanceOf(this.accounts[0]).call(); // call is a reading operation, send is a writing operation
    // call is always free
